...
const LightPillar: React.FC<LightPillarProps> = ({
    ...
    useEffect(() => {
        ...
        const qualitySettings = {
            low: { iterations: 18, waveIterations: 1, pixelRatio: 0.4, precision: 'mediump', stepMultiplier: 1.8 },
            medium: { iterations: 32, waveIterations: 2, pixelRatio: 0.55, precision: 'mediump', stepMultiplier: 1.4 },
            high: {
                iterations: 64,
                waveIterations: 4,
    ...
    `;
        ...
        const material = new THREE.ShaderMaterial({
            ...
            uniforms: {
                ...
                uRotCos: { value: 1.0 },
                uRotSin: { value: 0.0 },
                uSlant: { value: Math.tan(pillarRotRad) },
